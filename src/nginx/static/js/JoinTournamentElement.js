		...
		template.innerHTML = `
			<div class="bg-dark d-flex flex-row align-items-center rounded-3 gap-3 p-2">
				<div class="d-flex flex-column lh-1 text-break">
					<span name="join_name" class="text-white">tournameeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeent name</span>
				...
				<button type="button" class="btn btn-secondary py-1 px-3">Join</button>
			</div>
		`;
		return template;
	}
